#!/usr/bin/env python3
"""
Document Summarization LangGraph Agent Test Script.

This script tests the document summarization LangGraph agent using either a synchronous
...
async def test_client(url: str, port: int, api_key: str, files: List[Dict[str, Any]], syncronous: bool=False, threadless: bool=False):
    ...
    logger.info("=== Document Summarization Agent Test ===")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Summarization LangGraph Agent Test Script')
